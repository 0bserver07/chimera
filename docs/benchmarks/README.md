...
| L2 | [HumanEval+](https://github.com/evalplus/evalplus) | Extended test cases (164) | **GLM-5.1: 89.6%** (147/164) · **Haiku 4.5: 92.1%** (151/164) · **Sonnet 4.6: 93.9%** (154/164). Stricter EvalPlus tests on the same 164 problems; ~3-5pt drop from regular HumanEval. Raw in `data/humanevalplus-*-results.json`. Opus 4.7 deferred (budget). | — | PARTIAL | — |
