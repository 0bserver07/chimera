...
Each layer depends only on layers below it. You can use Layer 3 without Layer 5. Just similarly -- you don't need `model.fit()` to use a `Dense` layer.
...
| Framework design | Layer/Model/compile/fit | Architecture/Trainer/Strategy |
