...
- [Build SWE-Agent in 60 lines](./build-swe-agent-in-60-lines.md) — autonomous, test-driven posture.
- [Build Cline in 70 lines](./build-cline-in-70-lines.md) — plan-first two-phase pipeline.
- [Build Your Own Coding Agent](./build-your-own-coding-agent.md) — the longer walkthrough.
