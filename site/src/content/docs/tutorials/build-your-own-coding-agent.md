---
title: Build Your Own Coding Agent in 50 Lines
description: Step-by-step tutorial — go from a 4-line minimal agent to a fully-featured coding REPL with cost tracking, undo, and event monitoring.
---
...
> **Migrating from v0.4 / v0.5?** Legacy `chimera.AgentPreset.*` siblings emit a `DeprecationWarning` and will be removed in v0.7.0. Use `CodingAgent.from_preset(...)` above. See [v0.4 → v0.5 migration](/chimera/migrations/v0.4-to-v0.5/).
...
- [Build SWE-Agent in 60 lines](/chimera/tutorials/build-swe-agent-in-60-lines/) — minimal autonomous test-driven posture.
- [Build Aider in 50 lines](/chimera/tutorials/build-aider-in-50-lines/) — diff-first, conservative posture.
- [Build Cline in 70 lines](/chimera/tutorials/build-cline-in-70-lines/) — plan-then-act two-phase pipeline.
- [Architecture](/chimera/architecture/) — understand the 8-layer stack.
