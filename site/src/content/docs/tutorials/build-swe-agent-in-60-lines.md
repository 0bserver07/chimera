---
title: Build SWE-Agent in 60 Lines
description: Headline tutorial. Build a working SWE-Agent-style coding agent — minimal tools, ReAct loop, tests-as-oracle — from five chimera primitives. Includes verified output from a real Ollama Cloud run.
---
...
- [Build Your Own Coding Agent](/chimera/tutorials/build-your-own-coding-agent/) — the longer walkthrough with REPL, cost tracking, undo.
- [Architecture](/chimera/architecture/) — the 8-phase stack these primitives live in.
