---
title: Build Cline in 70 Lines
description: Tutorial — recreate a Cline-style plan-act-execute coding agent as a chimera Pipeline of two ReAct loops. Includes verified output from a real Ollama Cloud run.
---
...
- [Build SWE-Agent in 60 lines](/chimera/tutorials/build-swe-agent-in-60-lines/) — single-loop autonomous posture.
- [Build Aider in 50 lines](/chimera/tutorials/build-aider-in-50-lines/) — diff-first conservative posture.
- [Build Your Own Coding Agent](/chimera/tutorials/build-your-own-coding-agent/) — longer walkthrough with REPL, cost, undo.
