---
title: "The Benchmark Canary"
description: "Feed every benchmark adapter its own canonical solution and require a pass — the cheap check that catches a grader which cannot score, before it publishes a fabricated number."
---
