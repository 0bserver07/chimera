---
title: chimera otter worktree — branch isolation
description: worktree lets you peel off a session into an isolated git worktree so otter can experiment on a parallel checkout without disturbing your current branch.
---
