...
_LAZY_ATTRS: dict[str, str] = {
    ...
    "PanelPlacement": "chimera.plugins",
    "StatuslineSection": "chimera.plugins",
    "UICommand": "chimera.plugins",
    "UIExtensionRegistry": "chimera.plugins",
    "UIPanel": "chimera.plugins",
    "UIStatusline": "chimera.plugins",
